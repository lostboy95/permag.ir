...
elseif lang then
text = [[
🔰⚜️راهنمای عملکرد ربات ⚜️🔰

          ☆▪️▪️▪️▪️▪️▪️▪️▪️▪️☆
برای مدیریت ربات کافی است عبارت های زیر را بفرستید :) 

💠برای مشاهده دستورات مدیریت عبارت 《مدیریت 》را ارسال کنید .

💠برای مشاهده دستورات قفل عبارت 
《قفل ها》را ارسال کنید .

💠جهت آگاهی از آنلاین بودن
 عبارت 《آنلاینی》را ارسال کنید .

💠برای مشاهده ورژن و سازنده ربات عبارت 《درباره》را ارسال کنید .
          ☆▪️▪️▪️▪️▪️▪️▪️▪️▪️☆
